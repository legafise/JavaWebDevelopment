...
public class LinearProgramSymbolView implements View {
    ...
    public LinearProgramSymbolView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            request.putParameter(LinearProgramConstant.DATA_NAME, symbolsNumbersData);
