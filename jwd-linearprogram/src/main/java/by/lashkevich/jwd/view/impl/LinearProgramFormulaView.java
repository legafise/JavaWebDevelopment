...
public class LinearProgramFormulaView implements View {
    ...
    public LinearProgramFormulaView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            request.putParameter(LinearProgramConstant.DATA_NAME, squareRootFormulaData);
