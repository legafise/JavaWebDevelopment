 ...
 */
public class RandomArrayInsertionSortCommand implements Command {
    private final ArrayService arrayService;
    private final ArraysRandomDataCreator arraysCreator;

    public RandomArrayInsertionSortCommand() {
    ...
    public View execute(ArraysRequest request) throws ArraysCommandException {
        try {
            ...
            ArraysArray<Number> sortedArray = arrayService.insertionSort(array);
            ArraysArrayReporter.reportInsertionSortResult(sortedArray);
