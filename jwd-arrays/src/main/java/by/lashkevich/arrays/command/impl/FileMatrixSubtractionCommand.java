 ...
 */
public class FileMatrixSubtractionCommand implements Command {
    private final MatrixService matrixService;
    private final ArraysMatrixParser matrixParser;

    public FileMatrixSubtractionCommand() {
    ...
    public View execute(ArraysRequest request) throws ArraysCommandException {
        try {
            ...
            ArraysMatrix result = matrixService.subtractMatrices(firstMatrix, secondMatrix);
