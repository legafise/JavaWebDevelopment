...
public class FillMatrixDiagonalWithLockerCommand implements Command {
    ...
    public View execute(Request request) throws CommandException {
        try {
            ...
            matrixReporter.reportMatrixInfoAfterFillWithLock(matrixService.findMatrix());
            LockMainMatrixDiagonalElementAggregator.resetCounter();
