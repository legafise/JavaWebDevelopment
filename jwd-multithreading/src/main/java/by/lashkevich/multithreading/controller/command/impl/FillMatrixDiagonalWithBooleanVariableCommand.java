...
public class FillMatrixDiagonalWithBooleanVariableCommand implements Command {
    private MatrixDiagonalAggregatorService matrixDiagonalAggregatorService;
    private MatrixService matrixService;
    private MatrixReporter matrixReporter;

    public FillMatrixDiagonalWithBooleanVariableCommand() {
    ...
    public View execute(Request request) throws CommandException {
        try {
            ...
            matrixReporter.reportMatrixInfoAfterFillWithBooleanVariable(matrixService.findMatrix());
            BooleanVariableMainMatrixDiagonalElementAggregator.resetCounter();
