...
public class FillMatrixDiagonalWithSemaphoreCommand implements Command {
    private MatrixDiagonalAggregatorService matrixDiagonalAggregatorService;
    private MatrixService matrixService;
    private MatrixReporter matrixReporter;

    public FillMatrixDiagonalWithSemaphoreCommand() {
    ...
    public View execute(Request request) throws CommandException {
        try {
            ...
            matrixReporter.reportMatrixInfoAfterFillWithSemaphore(matrixService.findMatrix());
            SemaphoreMainMatrixDiagonalElementAggregator.resetCounter();
