...
public class FillMatrixDiagonalWithSetCommand implements Command {
    ...
    public View execute(Request request) throws CommandException {
        try {
            ...
            matrixReporter.reportMatrixInfoAfterFillWithSet(matrixService.findMatrix());
            SetMainMatrixDiagonalElementAggregator.resetIndexes();
