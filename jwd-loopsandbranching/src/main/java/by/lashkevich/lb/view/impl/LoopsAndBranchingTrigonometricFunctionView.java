 ...
 * on a job with trigonometric function calculation
 * Implements View interface
 * @author Roman Lashkevich
 * @see by.lashkevich.lb.view.View
 * @see by.lashkevich.lb.reader.LoopsAndBranchingReader
 */
public class LoopsAndBranchingTrigonometricFunctionView implements View {
    ...
    public LoopsAndBranchingTrigonometricFunctionView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            List<String> twoConditionFunctionData = dataReader.readTrigonometricFunctionData();
            request.putParameter(LoopsAndBranchingConstant.COMMAND_NUMBER, getViewCommandNumber());
            request.putParameter(LoopsAndBranchingConstant.DATA_NAME, twoConditionFunctionData);
