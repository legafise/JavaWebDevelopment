 ...
 * on a job with finding the least square of two numbers
 * Implements View interface
 * @author Roman Lashkevich
 * @see by.lashkevich.lb.view.View
 * @see by.lashkevich.lb.reader.LoopsAndBranchingReader
 */
public class LoopsAndBranchingLeastSquareFinderView implements View {
    ...
    public LoopsAndBranchingLeastSquareFinderView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            List<String> dateData = dataReader.readLeastSquareFinderTaskData();
