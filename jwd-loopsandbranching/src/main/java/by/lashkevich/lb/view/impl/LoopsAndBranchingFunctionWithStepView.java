...
public class LoopsAndBranchingFunctionWithStepView implements View {
    ...
    public LoopsAndBranchingFunctionWithStepView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            List<String> twoConditionFunctionData = dataReader.readFunctionWithStepData();
