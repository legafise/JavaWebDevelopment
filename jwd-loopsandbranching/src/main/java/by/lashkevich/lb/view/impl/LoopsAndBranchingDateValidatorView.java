 ...
 * on a job with date validation
 * Implements View interface
 * @author Roman Lashkevich
 * @see by.lashkevich.lb.view.View
 * @see by.lashkevich.lb.reader.LoopsAndBranchingReader
 * @see by.lashkevich.lb.entity.LoopsAndBranchingDate
 */
public class LoopsAndBranchingDateValidatorView implements View {
    ...
    public LoopsAndBranchingDateValidatorView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            List<String> dateData = dataReader.readDateValidatorTaskData();
            request.putParameter(LoopsAndBranchingConstant.COMMAND_NUMBER, getViewCommandNumber());
            request.putParameter(LoopsAndBranchingConstant.DATA_NAME, dateData);
