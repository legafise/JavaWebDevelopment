...
/**
 * Class for receiving and sending information to the controller on a job with access checking
 * Implements View interface
 * @author Roman Lashkevich
 * @see by.lashkevich.lb.view.View
 * @see by.lashkevich.lb.reader.LoopsAndBranchingReader
 */
public class LoopsAndBranchingAccessCheckerView implements View {
    ...
    public LoopsAndBranchingAccessCheckerView() {
    ...
    public void executeView() {
        ...
        try {
            ...
            List<String> symbolsNumbersData = dataReader.readAccessCheckerData();
