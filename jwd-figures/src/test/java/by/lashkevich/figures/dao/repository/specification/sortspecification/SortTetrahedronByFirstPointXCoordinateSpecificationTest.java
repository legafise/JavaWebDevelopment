...
public class SortTetrahedronByFirstPointXCoordinateSpecificationTest {
    @DataProvider(name = "dataForFirstPointXCoordinateSorting")
    public Object[][] createDataForFirstPointXCoordinateSorting() {
    ...
    @Test(description = "Different scenario of tetrahedron first point x coordinate sorting",
            dataProvider = "dataForFirstPointXCoordinateSorting")
    public void sortTetrahedronByVolumeTest(List<Tetrahedron> tetrahedronTestList, List<Tetrahedron> expectedResult) {
        tetrahedronTestList.sort(new SortTetrahedronByFirstPointYCoordinateSpecification().getComparator());
