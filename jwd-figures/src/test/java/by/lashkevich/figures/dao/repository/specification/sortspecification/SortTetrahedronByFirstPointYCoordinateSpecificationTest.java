...
public class SortTetrahedronByFirstPointYCoordinateSpecificationTest {
    @DataProvider(name = "dataForFirstPointYCoordinateSorting")
    public Object[][] createDataForFirstPointYCoordinateSorting() {
    ...
    @Test(description = "Different scenario of tetrahedron first point y coordinate sorting",
            dataProvider = "dataForFirstPointYCoordinateSorting")
